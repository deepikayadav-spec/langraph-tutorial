...
class MockChatModel:
    ...
    def invoke(self, messages: List[BaseMessage]) -> AIMessage:
        ...
        if "capital" in last_msg and "india" in last_msg:
            ...
            if user_name:
                reply += f" Thanks for asking, {user_name}!"
...
# SQLite-backed checkpointer — persists across restarts
# check_same_thread=False lets Streamlit's multi-thread model share the connection
